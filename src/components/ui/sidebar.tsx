...
>(({ className, onClick, showLabel = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      {showLabel && <span className="text-[0.8rem]">收起侧边栏</span>}
    </Button>
  );
});
...
const sidebarMenuButtonVariants = cva(
  cn(
    ...
    "outline-hidden ring-ring focus-visible:ring-1",
    ...
    "[&>svg]:data-[active=true]:text-primary",
    "[&>svg]:hover:text-foreground",
