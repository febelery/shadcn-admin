...
export function SurfaceFillInPreview({ title }: Props) {
    ...
    return (
      <p
        className={cn(
          ...
          'text-muted-foreground/70 border-border/60 rounded-md border border-dashed px-3 py-2.5'
        )}
      >
  ...
  return (
    <p
      className={cn(
        'text-foreground flex flex-wrap items-baseline gap-x-0.5',
