...
import { EndPagePanel } from '../settings/end-page-panel'
import { MetaCoverPanel } from '../settings/meta-cover-panel'
import { PublishInfoCard } from '../settings/publish-info-card'
import { SubmissionPanel } from '../settings/submission-panel'
import { ThemePanel } from '../settings/theme-panel'
import { TimeWindowPanel } from '../settings/time-window-panel'
import {
  InspectorFormField,
  InspectorSection,
