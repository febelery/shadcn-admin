      ...
      <InspectorFormGroup title='选项行为'>
        {CHOICE_WITH_OTHER.has(type) && (
          <>
            <div className='flex items-center justify-between gap-2'>
              <Label htmlFor='allow-other' className={builderTypeLabel}>
                允许「其他」自填
              </Label>
              <Switch
                id='allow-other'
            ...
            {allowOther && (
              <>
                <div className={builderFieldStack}>
                  <Label className={builderTypeLabel}>其他选项文案</Label>
                  <Input
                    value={otherLabel}
                    onChange={(e) => {
                ...
                <div className={builderFieldStack}>
                  <Label className={builderTypeLabel}>自填占位提示</Label>
                  <Input
        ...
        {CHOICE_WITH_LIMITS.has(type) && (
          <div className='grid grid-cols-2 gap-2'>
            <div className={builderFieldStack}>
              <Label className={builderTypeLabel}>最少选择</Label>
              <Input
                type='number'
                min={0}
            ...
            <div className={builderFieldStack}>
              <Label className={builderTypeLabel}>最多选择</Label>
              <Input
                type='number'
                min={1}
        ...
        {CHOICE_WITH_LAYOUT.has(type) && (
          <div className={builderFieldStack}>
            <Label className={builderTypeLabel}>选项排列</Label>
            <Select
            ...
            >
              <SelectTrigger className={cn('h-8', builderTypeControl)}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        {['single_choice', 'multiple_choice', 'dropdown', 'ranking'].includes(
          ...
          <div className='flex items-center gap-2'>
            ...
            />
            <Label htmlFor='randomize' className={builderTypeLabel}>
              作答时随机打乱选项顺序
            </Label>
          </div>
        )}
        ...
        {type === 'dropdown' && (
          <div className={builderFieldStack}>
            <Label className={builderTypeLabel}>下拉占位文案</Label>
            <Input
...
export function TextInputInspectorFields({
  ...
  return (
    <InspectorFormGroup title='输入设置'>
      <div className={builderFieldStack}>
        <Label className={builderTypeLabel}>占位提示</Label>
        <Input
      ...
      {type === 'textarea' && (
        <>
          <div className='grid grid-cols-2 gap-2'>
            <div className={builderFieldStack}>
              <Label className={builderTypeLabel}>显示行数</Label>
              <Input
                type='number'
                min={2}
                max={20}
            ...
            <div className={builderFieldStack}>
              <Label className={builderTypeLabel}>最大字数</Label>
              <Input
                type='number'
                min={1}
  ...
  return (
    <InspectorFormGroup title='数字范围'>
      ...
      <div className='grid grid-cols-3 gap-2'>
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>最小值</Label>
          <Input
            type='number'
        ...
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>最大值</Label>
          <Input
            type='number'
        ...
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>步长</Label>
          <Input
            type='number'
            min={0}
            value={config.step ?? ''}
...
export function DateInspectorFields({
  ...
  return (
    <InspectorFormGroup title='日期设置'>
      <div className={builderFieldStack}>
        <Label className={builderTypeLabel}>精度</Label>
        <Select
      ...
      <div className='grid grid-cols-2 gap-2'>
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>最早日期</Label>
          <Input
            type='date'
        ...
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>最晚日期</Label>
          <Input
            type='date'
...
export function NpsInspectorFields({
  ...
  return (
    <InspectorFormGroup title='NPS 量表'>
      ...
      <div className='grid grid-cols-2 gap-2'>
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>左侧说明（低分）</Label>
          <Input
        ...
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>右侧说明（高分）</Label>
          <Input
...
export function FileUploadInspectorFields({
  ...
  return (
    <InspectorFormGroup title='上传限制'>
      <div className='grid grid-cols-2 gap-2'>
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>最多文件数</Label>
          <Input
            type='number'
            min={1}
        ...
        <div className={builderFieldStack}>
          <Label className={builderTypeLabel}>单文件 MB 上限</Label>
          <Input
            type='number'
            min={1}
      ...
      <div className={builderFieldStack}>
        <Label className={builderTypeLabel}>允许类型</Label>
        <Input
          value={acceptStr}
