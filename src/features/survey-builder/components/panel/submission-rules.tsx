      ...
      body: () => (
        <div className="mt-2 space-y-2">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-[11px] text-muted-foreground">次 / 天</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-14 shrink-0 text-[11px] text-muted-foreground">
              识别方式
      ...
      body: () => (
        <div className="mt-2 space-y-2">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-[11px] text-muted-foreground">次（总量）</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-14 shrink-0 text-[11px] text-muted-foreground">
              超额后
        ...
        <div className="mt-2 space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Input
              ...
              onChange={(e) => updateRule('ipDedup', { limit: +e.target.value })}
              className="h-7 w-14 font-mono text-xs"
            />
            <span className="text-[11px] text-muted-foreground">次（总）</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-10 shrink-0 text-[11px] text-muted-foreground">
              超额后
      ...
      body: () => (
        <div className="mt-2 space-y-2">
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs text-foreground">同一账号仅能提交一次</span>
            <Switch
