...
export default function Login() {
  ...
  useEffect(() => {
    if (!state.needTwoFactor || state.countdown <= 0) {
  ...
  }, [state.needTwoFactor, state.countdown, handleBackToLogin]);
  ...
  const loginForm = () => (
    ...
    >
      <CardHeader className="space-y-3 pb-4">
        ...
        <CardTitle className="text-xl font-medium text-center">登录</CardTitle>
          ...
          <div className="relative w-full h-full">
            ...
            >
              <circle
                ...
                strokeWidth="4"
                strokeDasharray={`${
                  (state.countdown / QRCODE_EXPIRE) * 301
                } 301`}
                strokeLinecap="round"
              />
            </svg>
